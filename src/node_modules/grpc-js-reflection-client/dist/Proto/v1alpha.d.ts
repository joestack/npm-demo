...
export declare namespace grpc.reflection.v1alpha {
    ...
    export abstract class UnimplementedServerReflectionService {
        static definition: {
            ServerReflectionInfo: {
                ...
                requestSerialize: (message: ServerReflectionRequest) => Buffer;
                requestDeserialize: (bytes: Buffer) => ServerReflectionRequest;
                responseSerialize: (message: ServerReflectionResponse) => Buffer;
