...
export declare type ExchangeType = 'direct' | 'fanout' | 'topic' | 'headers' | string;
export declare type ExchangeParams = {
    /**
...
export declare type QueueParams = {
    /**
...
export declare type ConsumeParams = {
    /**
